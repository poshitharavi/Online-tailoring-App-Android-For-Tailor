...
public class HistoryOrderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String tailorId = loginPreferences.getString("tailor_id", "0");

        JsonArrayRequest req = new JsonArrayRequest(Request.Method.GET, getResources().getString(R.string.api_url) + "order/tailor-completed/" + tailorId, null, new Response.Listener<JSONArray>() {
            @Override
            public void onResponse(JSONArray response) {
                ...
                if (response.length() > 0) {
                    ...
                    ListviewCustomAdapter listviewCustomAdapter = new ListviewCustomAdapter(ordersList, HistoryOrderActivity.this);
                    historyListView.setAdapter(listviewCustomAdapter);
        ...
        bottomNavigationView.setSelectedItemId(R.id.historyView);
