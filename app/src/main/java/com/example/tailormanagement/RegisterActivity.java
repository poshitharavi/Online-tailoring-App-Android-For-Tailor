        ...
        saveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (emailTxt.getText().toString().length() > 0 && nameTxt.getText().toString().length() > 0 && passwordTxt.getText().toString().length() > 0){
                    ...
                    JsonObjectRequest req = new JsonObjectRequest(Request.Method.POST, getResources().getString(R.string.api_url) + "tailor/save", reqObj, new Response.Listener<JSONObject>() {
                        @Override
