...
public class OrderListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        JsonArrayRequest req = new JsonArrayRequest(Request.Method.GET, getResources().getString(R.string.api_url) + "order/tailor/" + tailorId, null, new Response.Listener<JSONArray>() {
            @Override
            public void onResponse(JSONArray response) {
                ...
                if (response.length() > 0) {
                    ...
                    ListviewCustomAdapter listviewCustomAdapter = new ListviewCustomAdapter(ordersList, OrderListActivity.this);
        ...
        bottomNavigationView.setSelectedItemId(R.id.ordersView);
